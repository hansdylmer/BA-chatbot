...
def run():
    with sync_playwright() as p:
        ...
        page.goto("https://www.su.dk/handicaptillaeg") # Main page for handicaptillæg
        ...
        # Retrieve all links for "handicaptillæg" sections. This should get all subsections of the main page.
        print("🔗 Retrieving links for 'handicaptillæg' sections...")
        links = []
        ...
        json_path = f"links_content{time.strftime('%Y-%m-%d')}.json"
